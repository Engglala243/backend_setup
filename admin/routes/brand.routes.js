...
const controllers = require("../controllers/brand.controller");
const schema = require("../validate_schema/brand.schema");
...
router.delete("/:id", verifyToken, controllers.deleteBrand);
