...
const controllers = require("../controllers/color.controller");
const schema = require("../validate_schema/color.schema");
...
router.delete("/:id", verifyToken, controllers.deleteColor);
